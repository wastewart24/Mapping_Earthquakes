...
// First Layer: Retrieve the earthquake GeoJSON data.
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  // First Layer: Creating a GeoJSON layer  (ALL EARTHQUAKES)
  L.geoJson(data, {
  ...
  // Second Layer: Use d3.json to make a call to get our Tectonic Plate geoJSON data. getting de raw URL
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data) {
  ...
  // Third Layer : 8. Add the major earthquakes layer to the map.   
...
// Displaying  color legend to the map.
legend.addTo(map);